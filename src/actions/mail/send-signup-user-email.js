...
export async function sendSignupUserEmail({ email, token }) {
  ...
  await transport.sendMail({
    ...
    <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #eaeaea; border-radius: 10px;">
      <h2 style="text-align: center; color: #3b82f6;">CQI OBE</h2>

      <p>Hi there,</p>

      <p>Please use the link below to verify your email address and continue on CQI OBE. This link will expire in ${VERIFICATION_TOKEN_EXP_MIN} minutes. If you don't think you should be receiving this email, you can safely ignore it.</p>
      ...
      <p>You received this email because you signed up for CQI OBE.</p>
